...
"""
	...
	INFORMATION:
		*Ce fichier contient les messages d'aide et les affiches dans
		une boite d'information
...
AVERTISSEMENT:\n
Les erreurs peuvent survenir lors de l\'exécution du programme:
Si vous cliquer sur \"Start\" dans la fenètre démarrer, 
vous devriez obligatoire passer une carte sur lecteur
RFID avant de fermer la fenètre.
Au cas contraire déconnecté la carte arduino
et vous pouvez ainsi fermer la fenètre.\n
...
Youtube  :\"Rachel Système\"
Facebook:\"Rachel Système\"
Linkedin  :\"Rachel Système\"
