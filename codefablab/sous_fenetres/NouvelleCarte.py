...
# Enregistre l'heure et la date le manager a ouvert la fenetre
import Boite_dialogue.SaveVisitManagerBadge as SVMB

F_icone 			= "codefablab/icones/icone.ico" # icone de la boite de dialogue	
F_Zone_Saisie 		= "codefablab/icones/Fond_Zone_De_Saisie.jpeg" # Arrière plan de la zone de saisie
F_Zone_Photo 		= "codefablab/icones/Fond_Zone_De_Photo.jpeg" # Arrière plan de la zone de photo
I_bouton_Annuler 	= "codefablab/icones/Bouton_annuler.png" # Icone bouton annuler
I_bouton_engistrer	= "codefablab/icones/Bouton_enregistrer.png" # Icone bouton enregistrer
I_bouton_insert_img = "codefablab/icones/Bouton_inser_image.png" # Icone bouton inserer image
I_bouton_reset_img  = "codefablab/icones/Bouton_reset.png" # Icone bouton restaurer image
Photo_Personnel 	= "codefablab/icones/Image_personnel.png" # image par defaut de la personne
...
class F_NouvelleCarte(tk.simpledialog.Dialog):
	...
	INFORMATION:
		*Ce fichier permet d'enregistrer les nouvelles cartes RFID

		*Les dossiers enregistrés se trouve dans le fichier 'Idpersonnel'
		si elle n'est pas créé, le programme le crée
	...
	def __init__(self, parent,title="Enregister nouvelle Carte"):
		Parent = parent
	...
	def buttonbox(self):
		...
		BoutonSave = tk.Button(self.ZoneSaisie, image=self.image_Bouton_Save, relief=tk.GROOVE,
			bd=3,width=self.WCP, height=self.HI, command=self.Enregister)
