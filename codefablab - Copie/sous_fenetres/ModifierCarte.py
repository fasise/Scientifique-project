...
F_icone 			= "icones/icone.ico" # icone de la boite de dialogue	
F_Zone_Saisie 		= "icones/Fond_Zone_De_Saisie.jpeg" # Arrière plan de la zone de saisie
F_Zone_Photo 		= "icones/Fond_Zone_De_Photo.jpeg" # Arrière plan de la zone de photo
I_bouton_Annuler 	= "icones/Bouton_annuler.png" # Icone bouton annuler
I_bouton_engistrer	= "icones/Bouton_enregistrer.png" # Icone bouton enregistrer
I_bouton_insert_img = "icones/Bouton_inser_image.png" # Icone bouton inserer image
I_bouton_reset_img  = "icones/Bouton_reset.png" # Icone bouton restaurer image
Photo_Personnel 	= "icones/Image_personnel.png" # image par defaut de la personne
