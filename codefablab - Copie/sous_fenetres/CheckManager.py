...
F_Zone_Saisie 	= "codefablab/icones/Fond_Zone_De_Saisie.jpeg" # Arrière plan de la fenêtre
Photo_Personnel = "codefablab/icones/Image_personnel.png" # image par defaut de la personne
		
I_bouton_fermer	= "codefablab/icones/Bouton_fermer.png" # Icone bouton enregistrer
I_bouton_ok	    = "codefablab/icones/Bouton_ok.png" # Icone bouton inserer image
